...
const analyzeResult = new Step({
  ...
  execute: async ({ context }) => {
    ...
    console.log(`Analyzing query result (success: ${success}, attempt: ${attemptCount}/${MAX_RETRIES})`);
    ...
    if (success) {
      ...
      const errorAnalysisPrompt = `
        ...
        ${shouldRetry ? 'Please provide a detailed analysis of what went wrong and how to correct it.' : 
        'Please provide a detailed analysis of what went wrong and suggest an alternative approach.'}
      `;
